...
const products: product[] = [
  {
    title:
      "Monitor LG ULTRAGEAR 144hz 1080p FUll HD com Display Port e HDMI 2.1",
    imageSrc: "/monitor_gamer.jpg",
    description:
      "The absolute best mouse of all times, it's so good that itś hard to describe how good itś, because it's that good",
    price: "797,98",
    id: 0,
  },
  {
