...
export async function seedFakeProductsOnDatabase(TotalNumberOfproducts) {
  ...
  function CreateFakeProduct(TotalNumberOfproducts) {
    for (let i = 0; i < TotalNumberOfproducts; i++) {
      const product = {
        ...
        image: "https://images.unsplash.com/photo-1722888061836-b3bae5fc5320?q=80&w=3174&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      };
  ...
  async function seedProducts(){
    ...
    await pool.end();
    console.log(`succesfully inserted ${TotalNumberOfproducts} in table products`)
  }
